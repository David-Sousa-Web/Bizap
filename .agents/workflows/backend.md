---
description: Regras para desenvolvimento backend Fastify — arquitetura, rotas, Prisma, autenticação, logging. Aplicar quando a tarefa envolver arquivos ou código em back/**
---
