...
export function AdvancedTab({ project }: AdvancedTabProps) {
  ...
  function handleCopyProjectId() {
    navigator.clipboard
      .writeText(String(project.id))
      .then(() =>
        toast.success("ID do projeto copiado para a área de transferência!"),
      )
      .catch(() => toast.error("Falha ao copiar o ID do projeto."));
  }
    ...
    <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
      <div className="grid gap-6 lg:grid-cols-2">
        <Card className="justify-between">
          <CardHeader>
            ...
            <CardDescription>
              Identificador único do projeto. Utilize este ID em integrações ou
              quando for solicitar suporte.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col gap-2 max-w-xl">
              <Label htmlFor="projectId">Identificador</Label>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Use a API Key abaixo para integrar sua aplicação externa (ex:
              disparo via backend do cliente) com este projeto no formato de
              Autenticação Bearer.
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card className="border-destructive/50 shadow-sm">
        <CardHeader>
          ...
          <CardDescription>
            Ações irreversíveis que mudarão permanentemente o estado deste
            projeto.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-sm font-medium mb-4">
            Ao excluir este projeto, você perderá a API Key e as configurações
            atreladas. Todas interações no chat pararão de funcionar para este
            escopo instantaneamente.
          </p>
        </CardContent>
          ...
          <AlertDialog>
            <AlertDialogTrigger asChild>
              <Button variant="destructive">
                Excluir Projeto de forma Permanente
              </Button>
            </AlertDialogTrigger>
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Esta ação não pode ser desfeita. Isto excluirá permanentemente
                  o projeto
                  <strong> {project.name} </strong> e removerá todos os dados do
                  banco.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
