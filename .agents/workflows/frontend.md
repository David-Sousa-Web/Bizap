---
description: Regras para desenvolvimento frontend React — arquitetura, componentes, estado, formulários, estilização. Aplicar quando a tarefa envolver arquivos ou código em front/**
---
